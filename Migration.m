...
%             ratio=ratio*6;
%         end
%         %% en limitant à 15 deg (gasdag.png) les reflecteurs profonds (probablement à fort ...
%         %% pendage) sont tronqués.        
%         clf
%         params_gaz=params(1:4);
%         params_gaz(4)=90;
%         params_gaz(2)=60;
...
%         end
%         %% Pas de différence observable entre la 0 et 0.1 tpad, mais changement de phase de l'ondelette
%         %% d'une forme antisymmétrique à une forme symétrique
...
%             %% stolt semble de moindre qualité en gle.
...
%         tout(2)=val_init;
%         
%         %% pspi retrouve les reflecteurs à la mi-profondeur sans laisser de trainéée blanche,...
...
%           %% superficielles du à la longueur de fenêtre un peu grande qui fait que le bruit en profond ...
%           %% affecte les interface précoces en temps, avec cette trainée blanche verticale,...
%           %% Pour le reste de la section le bruit est remplacé par des smiles
      end
  end
end
